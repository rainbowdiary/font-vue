<template>
  <div class="header">
    <i @click="$router.replace(`/msite`)" class="btn-close rainbow-close"></i>
    <div class="header-top">
      ...
      <div class="header-btn" @click="maskFlag=true" v-if="seller.supports&&seller.supports.length">
        ...
        <i class="btn-fontIcon rainbow-keyboard_arrow_rirainbow-ght"></i>
      </div>
      <div class="btn"></div>
    </div>
    <div class="header-bg">
    ...
    <div class="bulletin">
      ...
      <i @click="maskFlag=true"  class="bulletin-fontIcon rainbow-keyboard_arrow_right"></i>
    </div>
    <transition name="mask">
      <div class="mask" v-show="maskFlag">
        ...
        <div class="mask-footer">
          <i @click="maskFlag=false" class="footer-icon rainbow-close"></i>
        </div>
      </div>
    </transition>
  </div>
...
import ListsHeaderEle from "components/ListsHeaderEle"
